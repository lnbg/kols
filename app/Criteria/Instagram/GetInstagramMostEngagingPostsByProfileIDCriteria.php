...
class GetInstagramMostEngagingPostsByProfileIDCriteria implements CriteriaInterface
{
    ...
    public function apply($model, RepositoryInterface $repository)
    {
        ...
        ->select(\DB::raw('id, instagram_id, instagram_media.type, account_id, link, caption, thumbnail, image_url, video_url, sidecar_media, filter, tags, like_count, comment_count, sum(like_count + comment_count) as interactions_count'))
        ->groupBy('id')
